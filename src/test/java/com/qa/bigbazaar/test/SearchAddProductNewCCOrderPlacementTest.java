...
public class SearchAddProductNewCCOrderPlacementTest extends BaseTest {
	...
	public void testPayuOrder() {
		axisPage = checkoutPage.makePayuOrder("Credit Card","New Card",prop.getProperty("cardNum"),prop.getProperty("cardExpiry"),prop.getProperty("cardCvv"),prop.getProperty("cardName"));
