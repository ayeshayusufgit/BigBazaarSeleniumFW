...
public class SearchAddProductNewDCOrderPlacementTest extends BaseTest {
	...
	public void testPayuOrder() {
		axisPage = checkoutPage.makePayuOrder("Debit Card","New Card",prop.getProperty("cardNum"),prop.getProperty("cardExpiry"),prop.getProperty("cardCvv"),prop.getProperty("cardName"));
