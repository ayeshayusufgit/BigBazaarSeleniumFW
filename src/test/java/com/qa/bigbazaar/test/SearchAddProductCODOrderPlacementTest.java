...
public class SearchAddProductCODOrderPlacementTest extends BaseTest {
	...
	public void testPayuOrder() {
		orderSuccessPage = checkoutPage.makeCODOrder();
		...
		Assert.assertEquals(orderSuccessPage.getPaymentMode(), "COD");
