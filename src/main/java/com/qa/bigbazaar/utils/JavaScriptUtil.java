...
public class JavaScriptUtil {
	...
	public String getOverlayMessage(WebElement element) {
		JavascriptExecutor js = (JavascriptExecutor) driver;  
	    
	    //this will print the entire validity object shows which validity failed
	    System.out.println(js.executeScript("return arguments[0].validity",element));

	    //shows true if no validity failed else false if any failed
	    System.out.println(js.executeScript("return arguments[0].validity.valid",element));
	    
	    //shows the validityErorMessage that would be shown
	    System.out.println(js.executeScript("return arguments[0].validationMessage",element));
	    
		String message = js.executeScript("return arguments[0].validationMessage",element).toString();
		return message;
	}
